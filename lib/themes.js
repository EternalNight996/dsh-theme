...
// v0.2.2 起：每个 3D 场景是一个「程序化场景定义」——client 端按 sceneId 实例化对应几何/材质/动画。
...
export const BUILTIN_3D = [
  // 粒子地球：IcosahedronGeometry + ShaderMaterial（Points + 自定义顶点/片元 shader）。
  // 完全程序化，无外部贴图依赖：FBM 噪声生成陆地/海洋 + 圆形 mask 点精灵 + 海洋波浪 + 鼠标 orbit + 点击脉冲。
  {
    id: 'points-earth',
    name: '粒子地球',
    kind: '3d',
    dark: false,
    bgTexture: null, // 程序化，无需背景纹理
  },
]
...
export const DEFAULT_CONFIG = {
  ...
  threeSceneId: 'points-earth', // 3D 场景：默认「粒子地球」
  threeInteract: true,
