...
export function translucentTokens(themeAlpha = 0.75, dialogAlpha = 0.8) {
  ...
  return {
    ...
    // 字体颜色跟随 dsh 主题：亮色→深字，暗色→浅字（明暗原生适配）
    '--dsw-alias-label-primary': { light: '#18202c', dark: '#e7eaf0' },
    '--dsw-alias-label-secondary': { light: '#56606f', dark: '#9aa4b2' },
...
export const DEFAULT_CONFIG = {
  ...
  themeAlpha: 0.75, // 主题面板/气泡不透明度
  dialogAlpha: 0.8, // 对话栏不透明度
}
