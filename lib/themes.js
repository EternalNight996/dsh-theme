...
export function translucentTokens() {
  return {
    '--dsw-alias-bg-base': { light: 'rgba(248, 250, 253, 0.6)', dark: 'rgba(8, 12, 20, 0.56)' },
    '--dsw-alias-bg-layer-1': { light: 'rgba(255, 255, 255, 0.74)', dark: 'rgba(24, 30, 42, 0.7)' },
    '--dsw-alias-bg-layer-2': { light: 'rgba(255, 255, 255, 0.66)', dark: 'rgba(30, 38, 52, 0.6)' },
