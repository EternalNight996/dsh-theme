...
export function translucentTokens() {
  return {
    '--dsw-alias-bg-base': { light: 'rgba(250, 252, 255, 0.14)', dark: 'rgba(8, 12, 20, 0.12)' },
    '--dsw-alias-bg-layer-1': { light: 'rgba(255, 255, 255, 0.58)', dark: 'rgba(24, 30, 42, 0.5)' },
    '--dsw-alias-bg-layer-2': { light: 'rgba(255, 255, 255, 0.5)', dark: 'rgba(30, 38, 52, 0.45)' },
    ...
    '--dsw-specific-sidebar-fill': { light: 'rgba(238, 242, 248, 0.3)', dark: 'rgba(8, 12, 20, 0.3)' },
  }
}
