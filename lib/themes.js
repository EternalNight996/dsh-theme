...
export function translucentTokens() {
  return {
    '--dsw-alias-bg-base': { light: 'rgba(250, 252, 255, 0.08)', dark: 'rgba(8, 12, 20, 0.06)' },
    '--dsw-alias-bg-layer-1': { light: 'rgba(255, 255, 255, 0.38)', dark: 'rgba(24, 30, 42, 0.32)' },
    '--dsw-alias-bg-layer-2': { light: 'rgba(255, 255, 255, 0.34)', dark: 'rgba(30, 38, 52, 0.3)' },
    ...
    '--dsw-specific-sidebar-fill': { light: 'rgba(238, 242, 248, 0.22)', dark: 'rgba(8, 12, 20, 0.2)' },
  }
}
